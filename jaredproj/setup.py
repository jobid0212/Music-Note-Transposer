...
def build():
    ...
    command = [
        ...
        f'--add-data={os.path.join(current_dir, "ImageHoverWidget2.py")};.',
        f'--add-data={os.path.join(current_dir, "resource_utils.py")};.',
        
        # Add all image files with proper paths
        f'--add-data={os.path.join(current_dir, "altoclef.png")};.',
        f'--add-data={os.path.join(current_dir, "arrow.png")};.',
        f'--add-data={os.path.join(current_dir, "bassclef3.png")};.',
        f'--add-data={os.path.join(current_dir, "flat.png")};.',
        f'--add-data={os.path.join(current_dir, "natural.png")};.',
        f'--add-data={os.path.join(current_dir, "sharp.png")};.',
        f'--add-data={os.path.join(current_dir, "trebelclef.png")};.',
        f'--add-data={os.path.join(current_dir, "wholenote.png")};.',
